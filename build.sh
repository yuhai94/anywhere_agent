...
echo "=== Anywhere Agent Build Script ==="
...
# 编译Go代码
echo "Building Agent binary for $GOOS-$ARCH..."
...
cp -f conf/config.yaml.example "$CONF_DIR/conf.yaml.example"
...
cp -f scripts/aw_agent.service "$BASE_DIR/"
...
echo "Systemd Service: $BASE_DIR/aw_agent.service"
echo
